...
namespace UangKuAPI.EntitySpaces.Generated
{
	...
	abstract public partial class esSubdistricts : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(string subdisID)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, string subdisID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(string subdisID)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(string subdisID)
		{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public string SubdisName
		{
			get
			{
		...
		public SubdistrictsQuery Query
		{
			get
			{
				if (query == null)
				{
                    query = new SubdistrictsQuery("Subdistricts");
					InitQuery(query);
				}
		...
		{
            InitQuery((SubdistrictsQuery)query);
		}
	...
	abstract public partial class esSubdistrictsQuery : esDynamicQuery
	{
        ...
        protected override esQueryItem QueryItemFromName(string name)
        {
            switch (name)
            {
				...
				case "SubdisName": return SubdisName;
	...
	public partial class SubdistrictsMetadata : esMetadata, IMetadata
	{
		...
		protected SubdistrictsMetadata()
		{
			...
			c = new esColumnMetadata(ColumnNames.SubdisID, 0, typeof(int), esSystemType.Int32);
			c.PropertyName = PropertyNames.SubdisID;
			c.IsAutoIncrement = true;
			c.NumericPrecision = 11;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.SubdisName, 1, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.SubdisName;
