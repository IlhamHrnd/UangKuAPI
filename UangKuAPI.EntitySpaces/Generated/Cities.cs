...
Date Generated       : 9/28/2024 4:20:19 PM
===============================================================================
*/
...
namespace UangKuAPI.EntitySpaces.Generated
{
	...
	abstract public partial class esCities : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(string cityID)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, string cityID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(string cityID)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(string cityID)
		{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public string CityName
		{
			get
			{
	...
	public partial class CitiesMetadata : esMetadata, IMetadata
	{
		...
		protected CitiesMetadata()
		{
			...
			c = new esColumnMetadata(ColumnNames.CityID, 0, typeof(int), esSystemType.Int32);
			c.PropertyName = PropertyNames.CityID;
			c.IsAutoIncrement = true;
			c.NumericPrecision = 11;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.CityName, 1, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.CityName;
			c.CharacterMaxLength = 255;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.ProvID, 2, typeof(int), esSystemType.Int32);
