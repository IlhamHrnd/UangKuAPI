...
namespace UangKuAPI.EntitySpaces.Generated
{
	...
	{	
		...
		static public void Delete(string documentID, string personID)
		{
	    ...
	    static public void Delete(string documentID, string personID, esSqlAccessType sqlAccessType)
		{
			var obj = new UserDocument();
			obj.DocumentID = documentID;
			obj.PersonID = personID;
	...
	{
		public UserDocument FindByPrimaryKey(string documentID, string personID)
		{
	...
	abstract public partial class esUserDocument : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(string documentID, string personID)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, string documentID, string personID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(string documentID, string personID)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(string documentID, string personID)
		{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public string FileExtention
		{
			get
			{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public DateTime? DocumentDate
		{
			get
			{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public sbyte? IsDeleted
		{
			get
			{
		...
		public UserDocumentQuery Query
		{
			get
			{
				if (query == null)
				{
                    query = new UserDocumentQuery("UserDocument");
					InitQuery(query);
				}
		...
		{
            InitQuery((UserDocumentQuery)query);
		}
	...
	abstract public partial class esUserDocumentQuery : esDynamicQuery
	{
        ...
        protected override esQueryItem QueryItemFromName(string name)
        {
            switch (name)
            {
				...
				case "FileExtention": return FileExtention;
	...
	public partial class UserDocumentMetadata : esMetadata, IMetadata
	{
		...
		protected UserDocumentMetadata()
		{
			...
			c = new esColumnMetadata(ColumnNames.DocumentID, 0, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.DocumentID;
			...
			c = new esColumnMetadata(ColumnNames.FileName, 2, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.FileName;
			c.CharacterMaxLength = 1000;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.FileExtention, 3, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.FileExtention;
			c.CharacterMaxLength = 4;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.Note, 4, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.Note;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.DocumentDate, 5, typeof(DateTime), esSystemType.DateTime);
			c.PropertyName = PropertyNames.DocumentDate;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.FilePath, 6, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.FilePath;
			c.CharacterMaxLength = 1000;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.IsDeleted, 7, typeof(sbyte), esSystemType.SByte);
			...
			c = new esColumnMetadata(ColumnNames.CreatedDateTime, 10, typeof(DateTime), esSystemType.DateTime);
			c.PropertyName = PropertyNames.CreatedDateTime;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.CreatedByUserID, 11, typeof(string), esSystemType.String);
