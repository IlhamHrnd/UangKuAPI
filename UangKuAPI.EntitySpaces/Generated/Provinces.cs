...
Date Generated       : 9/28/2024 4:19:57 PM
===============================================================================
*/
...
namespace UangKuAPI.EntitySpaces.Generated
{
	...
	abstract public partial class esProvinces : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(string provincesID)
		{
			if(this.es.Connection.SqlAccessType == esSqlAccessType.DynamicSQL)
				return LoadByPrimaryKeyDynamic(provincesID);
			else
				return LoadByPrimaryKeyStoredProcedure(provincesID);
		}

		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, string provincesID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(string provincesID)
		{
			ProvincesQuery query = new ProvincesQuery("Provinces");
			query.Where(query.ProvID == provincesID);
			return Load(query);
		}

		private bool LoadByPrimaryKeyStoredProcedure(string provinceID)
		{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public string ProvName
		{
			get
			{
		...
		public ProvincesQuery Query
		{
			get
			{
				if (query == null)
				{
                    query = new ProvincesQuery("Provinces");
					InitQuery(query);
				}
		...
		{
            InitQuery((ProvincesQuery)query);
		}
	...
	public partial class ProvincesMetadata : esMetadata, IMetadata
	{
		...
		protected ProvincesMetadata()
		{
			...
			c = new esColumnMetadata(ColumnNames.ProvID, 0, typeof(int), esSystemType.Int32);
			c.PropertyName = PropertyNames.ProvID;
			c.IsAutoIncrement = true;
			c.NumericPrecision = 11;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.ProvName, 1, typeof(string), esSystemType.String);
			c.PropertyName = PropertyNames.ProvName;
			c.CharacterMaxLength = 255;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.LocationID, 2, typeof(int), esSystemType.Int32);
			c.PropertyName = PropertyNames.LocationID;
			c.NumericPrecision = 11;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(ColumnNames.Status, 3, typeof(int), esSystemType.Int32);
			c.PropertyName = PropertyNames.Status;
			c.NumericPrecision = 11;
			c.HasDefault = true;
			c.Default = @"1";
			c.IsNullable = true;
