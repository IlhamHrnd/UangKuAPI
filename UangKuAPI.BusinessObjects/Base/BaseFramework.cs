...
public partial class BaseFramework : DbContext
{
    private readonly IConfiguration _config;
    public BaseFramework(DbContextOptions<BaseFramework> options, IConfiguration config) : base(options)
    {
        try
        {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var conn = _config.GetConnectionString("DatabaseConnection");
            optionsBuilder.UseMySql(conn, new MariaDbServerVersion("10.6.19-mariadb"));
        }
    }
