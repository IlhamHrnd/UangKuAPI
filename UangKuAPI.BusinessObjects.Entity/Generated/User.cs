...
namespace UangKuAPI.BusinessObjects.Entity.Generated
{
	...
	abstract public partial class esUser : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(System.String username, System.String password)
		{
			if(this.es.Connection.SqlAccessType == esSqlAccessType.DynamicSQL)
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, System.String username, System.String password)
		{
			if (sqlAccessType == esSqlAccessType.DynamicSQL)
				return LoadByPrimaryKeyDynamic(username, password);
			else
		...
		private bool LoadByPrimaryKeyDynamic(System.String username, System.String password)
		{
			UserQuery query = new UserQuery("User");
		...
		private bool LoadByPrimaryKeyStoredProcedure(System.String username, System.String password)
		{
			esParameters parms = new esParameters();
			parms.Add("Username", username);
