...
namespace UangKuAPI.BusinessObjects.Entity.Generated
{
	...
	abstract public partial class esDistricts : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(System.String disID)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, System.String disID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(System.String disID)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(System.String disID)
		{
