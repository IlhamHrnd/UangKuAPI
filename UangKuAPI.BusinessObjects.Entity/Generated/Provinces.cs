...
namespace UangKuAPI.BusinessObjects.Entity.Generated
{
	...
	abstract public partial class esProvinces : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(System.String provincesID)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, System.String provincesID)
		{
		...
		private bool LoadByPrimaryKeyDynamic(System.String provincesID)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(System.String provinceID)
		{
